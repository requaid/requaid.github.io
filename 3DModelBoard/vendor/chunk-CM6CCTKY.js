import{a as e}from"./chunk-L5WUWJUF.js";var t="gaussianSplattingVertexDeclaration",s="attribute vec3 position;attribute vec4 splatIndex0;attribute vec4 splatIndex1;attribute vec4 splatIndex2;attribute vec4 splatIndex3;uniform mat4 view;uniform mat4 projection;uniform mat4 world;uniform vec4 vEyePosition;";e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=s);var d={name:t,shader:s};var o="gaussianSplattingUboDeclaration",c=`#include<sceneUboDeclaration>
...
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=c);var r="gaussianSplatting",l=`#if !defined(WEBGL2) && !defined(WEBGPU) && !defined(NATIVE)
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=l);var a="gaussianSplattingVertexShader",i=`#include<__decl__gaussianSplattingVertex>
...
`;e.ShadersStore[a]||(e.ShadersStore[a]=i);var b={name:a,shader:i};export{d as a,b};
