...
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=R);var r="openpbrFragmentSamplersDeclaration",A=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=A);var t="openpbrNormalMapFragmentMainFunctions",N=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=N);var a="openpbrNormalMapFragmentFunctions",T=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=T);var n="openpbrConductorReflectance",b=`#define pbr_inline
...
#endif
outParams.F0=1.0;outParams.F90=1.0;return outParams;}`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=b);var s="openpbrAmbientOcclusionFunctions",L=`float compute_specular_occlusion(const float n_dot_v,const float metallic,const float ambient_occlusion,const float roughness)
...
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=L);var f="openpbrVolumeFunctions",F=`struct OpenPBRHomogeneousVolume {vec3 extinction_coeff; 
vec3 ss_albedo; 
...
weight_sum.b<1e-5f ? unconvolved_irradiance.b : irradiance_sum.b/weight_sum.b);}`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=F);var l="openpbrNormalMapFragment",O=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=O);var c="openpbrBlockNormalFinal",C=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=C);var _="openpbrBaseLayerData",D=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);float geometry_thickness=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=D);var d="openpbrCoatLayerData",P=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=P);var m="openpbrThinFilmLayerData",M=`#ifdef THIN_FILM
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=M);var u="openpbrFuzzLayerData",x=`float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=x);var p="openpbrAmbientOcclusionData",G=`vec3 ambient_occlusion=vec3(1.0);float specular_ambient_occlusion=1.0;float coat_specular_ambient_occlusion=1.0;
#ifdef AMBIENT_OCCLUSION
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=G);var g="openpbrBackgroundTransmission",y=`vec4 slab_translucent_background=vec4(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=y);var v="openpbrEnvironmentLighting",z=`#ifdef REFLECTION
...
#endif
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=z);var E="openpbrDirectLightingInit",W=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=W);var h="openpbrDirectLighting",U=`#ifdef LIGHT{X}
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=U);var I="openpbrBlockPrePass",X=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=X);var o="openpbrPixelShader",S=`#define OPENPBR_FRAGMENT_SHADER
...
`;e.ShadersStore[o]||(e.ShadersStore[o]=S);var xo={name:o,shader:S};export{xo as a};
