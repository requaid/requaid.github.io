import{a as e}from"./chunk-L5WUWJUF.js";var r="geometryVertexDeclaration",t="uniform mat4 viewProjection;uniform mat4 view;";e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=t);var n="geometryUboDeclaration",d=`#include<sceneUboDeclaration>
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=d);var i="geometryVertexShader",o=`precision highp float;
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=o);var x={name:i,shader:o};export{x as a};
