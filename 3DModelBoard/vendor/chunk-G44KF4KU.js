...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=D);var a="samplerFragmentAlternateDeclaration",M=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=h);var o="pbrBlockAlbedoOpacity",F=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=F);var f="pbrBlockReflectivity",g=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=g);var t="pbrBlockAmbientOcclusion",P=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=P);var c="pbrBlockAlphaFresnel",U=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=U);var l="pbrBlockAnisotropic",b=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=b);var d="pbrBlockReflection",y=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=y);var s="pbrBlockSheen",B=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=B);var E="pbrBlockClearcoat",G=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=G);var R="pbrBlockIridescence",V=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=V);var C="pbrBlockSubSurface",H=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=H);var S="pbrBlockReflectance0",x=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=x);var m="pbrClusteredLightingFunctions",W=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=W);var u="pbrBlockNormalFinal",Y=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=Y);var A="pbrBlockLightmapInit",k=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=k);var I="pbrBlockGeometryInfo",X=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=X);var v="pbrBlockReflectance",w=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=w);var N="pbrBlockDirectLighting",K=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=K);var T="pbrBlockFinalLitComponents",z=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=z);var O="pbrBlockFinalUnlitComponents",Z=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=Z);var p="pbrBlockFinalColorComposition",q=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=q);var L="pbrBlockPrePass",J=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=J);var i="pbrPixelShader",_=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=_);var on={name:i,shader:_};export{on as a};
