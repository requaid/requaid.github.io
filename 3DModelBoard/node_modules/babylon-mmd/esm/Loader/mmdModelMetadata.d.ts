...
export declare namespace MmdModelMetadata {
    /**
     ...
     */
    type Morph = GroupMorph | BoneMorph | MaterialMorph | VertexMorph | UvMorph;
    /**
     ...
     */
    interface GroupMorph extends BaseMorph {
        /**
         * Morph type
         */
     ...
     */
    interface BoneMorph extends BaseMorph {
        /**
         * Morph type
         */
     ...
     */
    interface MaterialMorph extends BaseMorph {
        /**
         * Morph type
         */
     ...
     */
    interface VertexMorph extends BaseMorph {
        /**
         * Morph type
         */
     ...
     */
    interface UvMorph extends BaseMorph {
        /**
         * Morph type
         */
     ...
     */
    type SerializationMorph = GroupMorph | BoneMorph | MaterialMorph | SerializationVertexMorph | SerializationUvMorph;
    /**
     * Vertex morph information for serialization
     */
    interface SerializationVertexMorph extends VertexMorph {
        elements: SerializationVertexMorphElement[];
    }
    /**
     * Vertex morph element information for serialization
     */
    interface SerializationVertexMorphElement {
        /**
         * Mesh index
         */
     ...
     */
    interface SerializationUvMorph extends UvMorph {
        elements: SerializationUvMorphElement[];
    }
    /**
     * UV morph element information for serialization
     */
    interface SerializationUvMorphElement {
        /**
         * Mesh index
         */
        readonly meshIndex: number;
     ...
     */
    interface SerializationBone extends Bone {
        /**
     ...
     */
    function isSerializationMetadata(metadata: MmdModelMetadata): metadata is MmdModelSerializationMetadata;
}
