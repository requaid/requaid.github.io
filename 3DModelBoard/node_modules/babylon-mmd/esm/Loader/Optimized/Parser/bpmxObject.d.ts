...
export declare namespace BpmxObject {
    /**
     * Header of the BPMX file
     */
     ...
     */
    type Material = Omit<PmxObject.Material, "indexCount"> & Readonly<{
        /**
     ...
     * @see PmxObject.Morph
     */
    type Morph = PmxObject.Morph.GroupMorph | Morph.VertexMorph | PmxObject.Morph.BoneMorph | Morph.UvMorph | PmxObject.Morph.MaterialMorph;
    namespace Morph {
        /**
         * Type of the morph
         */
        type Type = PmxObject.Morph.Type.GroupMorph | PmxObject.Morph.Type.VertexMorph | PmxObject.Morph.Type.BoneMorph | PmxObject.Morph.Type.UvMorph | PmxObject.Morph.Type.AdditionalUvMorph1 | PmxObject.Morph.Type.AdditionalUvMorph2 | PmxObject.Morph.Type.AdditionalUvMorph3 | PmxObject.Morph.Type.AdditionalUvMorph4 | PmxObject.Morph.Type.MaterialMorph;
        /**
         * Vertex morph is a morph that moves the vertex
         */
        type VertexMorph = PmxObject.Morph.BaseMorph & Readonly<{
            /**
             * Type of the morph
             */
         ...
         */
        type VertexMorphElement = Readonly<{
            /**
             * mesh index
             */
            meshIndex: number;
         ...
         */
        type UvMorph = PmxObject.Morph.BaseMorph & Readonly<{
            /**
             * Type of the morph
             */
            type: PmxObject.Morph.Type.UvMorph | PmxObject.Morph.Type.AdditionalUvMorph1 | PmxObject.Morph.Type.AdditionalUvMorph2 | PmxObject.Morph.Type.AdditionalUvMorph3 | PmxObject.Morph.Type.AdditionalUvMorph4;
            /**
             * UV morph elements
             */
     ...
     */
    type DisplayFrame = PmxObject.DisplayFrame;
    /**
     * Rigid body information of the model
     *
     ...
     */
    type RigidBody = PmxObject.RigidBody;
    /**
     * Joint information of the model
     *
