 ...
 */
export declare class BvmdLoader {
    ...
    private readonly _v300Int;
    private readonly _v310Int;
    /**
     ...
     */
    loadFromBuffer(name: string, buffer: ArrayBufferLike): MmdAnimation;
    private _parseBoneTracks;
    private _parseMovableBoneTracks;
    private _parseMorphTracks;
    private _parsePropertyTrack;
    private _parseCameraTrack;
    /**
     ...
     */
    load(name: string, fileOrUrl: File | string, onLoad: (animation: MmdAnimation) => void, onProgress?: (event: ISceneLoaderProgressEvent) => void, onError?: ((request?: WebRequest | undefined, exception?: Error | undefined) => void) | undefined): IFileRequest;
    /**
     ...
     * @returns Animation data
     */
    loadAsync(name: string, fileOrUrl: File | string, onProgress?: (event: ISceneLoaderProgressEvent) => void): Promise<MmdAnimation>;
    /**
