...
export interface IMmdRuntime<TMmdModel extends IMmdModel = IMmdModel> extends ILogger {
     ...
     */
    createMmdModel<TMaterial extends Material>(mmdSkinedMesh: Mesh, options?: IMmdModelCreationOptions<TMaterial>): TMmdModel;
    /**
     ...
     * @param options Creation options
     */
    createMmdModelFromSkeleton<TMaterial extends Material>(mmdSkinedMesh: MmdSkinnedMesh, skeleton: IMmdLinkedBoneContainer, options?: IMmdModelCreationOptions<TMaterial>): TMmdModel;
    /**
     * Destroy MMD model
     *
