...
export class MmdRuntime {
    ...
    afterPhysics(): void;
    beforePhysics(frame_time?: number | null): void;
    static bufferedBeforePhysics(mmd_runtime: MmdRuntime, frame_time?: number | null): void;
    static bufferedUpdate(mmd_runtime: MmdRuntime, frame_time?: number | null): void;
...
export interface InitOutput {
    ...
    readonly mmdruntime_beforePhysics: (a: number, b: number) => void;
    readonly mmdruntime_bufferedBeforePhysics: (a: number, b: number) => void;
    readonly mmdruntime_bufferedUpdate: (a: number, b: number) => void;
