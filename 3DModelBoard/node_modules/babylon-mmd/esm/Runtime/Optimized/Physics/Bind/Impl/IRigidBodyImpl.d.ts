...
export interface IRigidBodyImpl {
    ...
    commitToWasm?(wasmInstance: IBulletWasmInstance, bodyPtr: number, motionStatePtr: IWasmTypedArray<Float32Array>, kinematicStatePtr: IWasmTypedArray<Uint8Array>, worldTransformPtr: Nullable<IWasmTypedArray<Float32Array>>): void;
    setTransformMatrixFromArray(motionStatePtr: IWasmTypedArray<Float32Array>, kinematicStatePtr: IWasmTypedArray<Uint8Array>, array: DeepImmutable<Tuple<number, 16>>, offset: number): void;
    ...
    setDamping(wasmInstance: IBulletWasmInstance, bodyPtr: number, linearDamping: number, angularDamping: number): void;
    ...
    setMassProps(wasmInstance: IBulletWasmInstance, bodyPtr: number, mass: number, localInertia: DeepImmutable<Vector3>): void;
