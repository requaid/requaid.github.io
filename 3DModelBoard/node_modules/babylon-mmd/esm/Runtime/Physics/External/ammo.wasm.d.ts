...
declare namespace Ammo {
    ...
    class btFace {
        ...
        set_m_plane(m_plane: readonly number[]): void;
    }
    ...
    class Face {
        get_m_n(): readonly Node[];
        set_m_n(m_n: readonly Node[]): void;
    ...
    class btSoftBody extends btCollisionObject {
        constructor(worldInfo: btSoftBodyWorldInfo, node_count: number, x: btVector3, m: readonly number[]);
        get_m_cfg(): Config;
    ...
    class btSoftBodyHelpers {
        ...
        CreatePatchUV(worldInfo: btSoftBodyWorldInfo, corner00: btVector3, corner10: btVector3, corner01: btVector3, corner11: btVector3, resx: number, resy: number, fixeds: number, gendiags: boolean, tex_coords: readonly number[]): btSoftBody;
