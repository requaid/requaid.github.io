(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("babylon-mmd", [], factory);
	else if(typeof exports === 'object')
		exports["babylon-mmd"] = factory();
	else
		root["BABYLONMMD"] = factory();
})((typeof self !== "undefined" ? self : typeof global !== "undefined" ? global : this), () => {
return /******/ (() => { // webpackBootstrap
/******/ 	"use strict";
/******/ 	var __webpack_modules__ = ({

/***/ "./src/Runtime/Optimized/wasm/md/index_bg.wasm"
/*!*****************************************************!*\
  !*** ./src/Runtime/Optimized/wasm/md/index_bg.wasm ***!
  \*****************************************************/
(module, __unused_webpack_exports, __webpack_require__) {

module.exports = __webpack_require__.p + "46174bf6cce20b05ee38.wasm";

/***/ },

/***/ "./src/Runtime/Optimized/wasm/md/index.js"
/*!************************************************!*\
  !*** ./src/Runtime/Optimized/wasm/md/index.js ***!
  \************************************************/
...
/* harmony export */   AnimationPool: () => (/* binding */ AnimationPool),
/* harmony export */   MmdRuntime: () => (/* binding */ MmdRuntime),
/* harmony export */   __wasm: () => (/* binding */ wasm),
/* harmony export */   allocateBuffer: () => (/* binding */ allocateBuffer),
/* harmony export */   createAnimationPool: () => (/* binding */ createAnimationPool),
/* harmony export */   createMmdRuntime: () => (/* binding */ createMmdRuntime),
/* harmony export */   deallocateBuffer: () => (/* binding */ deallocateBuffer),
...
/* harmony export */ });
/* harmony import */ var _snippets_wasm_bindgen_rayon_38edf6e439f6d70d_src_workerHelpers_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./snippets/wasm-bindgen-rayon-38edf6e439f6d70d/src/workerHelpers.js */ "./src/Runtime/Optimized/wasm/md/snippets/wasm-bindgen-rayon-38edf6e439f6d70d/src/workerHelpers.js");
...
class AnimationPool {
    ...
    getNthMorphBindIndexMap(morph_bind_index_map, index) {
        ...
        _assertNum(morph_bind_index_map);
        _assertNum(index);
        const ret = wasm.animationpool_getNthMorphBindIndexMap(this.__wbg_ptr, morph_bind_index_map, index);
        return ret >>> 0;
    }
    /**
     * @param {number} animation_ptr
...
if (Symbol.dispose) AnimationPool.prototype[Symbol.dispose] = AnimationPool.prototype.free;
...
class MmdRuntime {
    ...
    /**
     * @param {MmdRuntime} mmd_runtime
     * @param {number | null} [frame_time]
     */
    static bufferedBeforePhysics(mmd_runtime, frame_time) {
        _assertClass(mmd_runtime, MmdRuntime);
        if (mmd_runtime.__wbg_ptr === 0) {
            throw new Error('Attempt to use a moved value');
        }
        if (!isLikeNone(frame_time)) {
            _assertNum(frame_time);
        }
        wasm.mmdruntime_bufferedBeforePhysics(mmd_runtime.__wbg_ptr, isLikeNone(frame_time) ? 0x100000001 : Math.fround(frame_time));
    }
    /**
     * @param {MmdRuntime} mmd_runtime
     * @param {number | null} [frame_time]
     */
    static bufferedUpdate(mmd_runtime, frame_time) {
        _assertClass(mmd_runtime, MmdRuntime);
        if (mmd_runtime.__wbg_ptr === 0) {
            throw new Error('Attempt to use a moved value');
        }
        ...
        wasm.mmdruntime_bufferedUpdate(mmd_runtime.__wbg_ptr, isLikeNone(frame_time) ? 0x100000001 : Math.fround(frame_time));
    }
    /**
     * @param {number} ptr
     * @returns {number}
...
if (Symbol.dispose) MmdRuntime.prototype[Symbol.dispose] = MmdRuntime.prototype.free;
...
function __wbg_get_imports(memory) {
    const import0 = {
        ...
        __wbg_startWorkers_8b582d57e92bd2d4: function() { return logError(function (arg0, arg1, arg2) {
            const ret = (0,_snippets_wasm_bindgen_rayon_38edf6e439f6d70d_src_workerHelpers_js__WEBPACK_IMPORTED_MODULE_0__.startWorkers)(arg0, arg1, wbg_rayon_PoolBuilder.__wrap(arg2));
            return ret;
        }, arguments); },
...
async function __wbg_init(module_or_path, memory) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL(/* asset import */ __webpack_require__(/*! index_bg.wasm */ "./src/Runtime/Optimized/wasm/md/index_bg.wasm"), __webpack_require__.b);
    }
    const imports = __wbg_get_imports(memory);
...
/***/ "./src/Runtime/Optimized/wasm/md/snippets/wasm-bindgen-rayon-38edf6e439f6d70d/src/workerHelpers.js"
/*!*********************************************************************************************************!*\
  !*** ./src/Runtime/Optimized/wasm/md/snippets/wasm-bindgen-rayon-38edf6e439f6d70d/src/workerHelpers.js ***!
  \*********************************************************************************************************/
(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
waitForMsgType(self, 'wasm_bindgen_worker_init').then(async ({ init, receiver }) => {
  ...
  // the main thread).
  const pkg = await Promise.resolve(/*! import() eager */).then(__webpack_require__.bind(__webpack_require__, /*! ../../.. */ "./src/Runtime/Optimized/wasm/md/index.js"));
...
async function startWorkers(module, memory, builder) {
  ...
  _workers = await Promise.all(
    Array.from({ length: builder.numThreads() }, async () => {
      ...
      const worker = new Worker(new URL(/* worker import */ __webpack_require__.p + __webpack_require__.u("src_Runtime_Optimized_wasm_md_snippets_wasm-bindgen-rayon-38edf6e439f6d70d_src_workerHelpers_js"), __webpack_require__.b), {
        type: undefined
      });
...
/******/ 		var installedChunks = {
/******/ 			"src_Runtime_Optimized_wasm_md_snippets_wasm-bindgen-rayon-38edf6e439f6d70d_src_workerHelpers_js": 1
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/Runtime/Optimized/wasm/md/snippets/wasm-bindgen-rayon-38edf6e439f6d70d/src/workerHelpers.js");
/******/ 	
/******/ 	return __webpack_exports__;
/******/ })()
;
});
//# sourceMappingURL=src_Runtime_Optimized_wasm_md_snippets_wasm-bindgen-rayon-38edf6e439f6d70d_src_workerHelpers_js.babylon.mmd.js.map